...
permalink: /posts/low-power-writing-setup/
---
...
{% include image.html image="/assets/images/posts/low-power.png" caption="My AYN Odin, hooked up to a keyboard and a monitor." %}
...
- I wanted it to be cheap to run on solar, which I'm transitioning to for the earthbag homestead
