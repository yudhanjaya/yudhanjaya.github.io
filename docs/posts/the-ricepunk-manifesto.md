...
nav_order: 4
date: 2022-06-01
excerpt: "Towards a new theme, or a horrendously jumbled set of concerns. A framework for science fiction that centers South Asian relationships, hybrid cultures, and the shit sandwich."
permalink: /posts/the-ricepunk-manifesto/
---
...
**Towards a new theme, or a horrendously jumbled set of concerns**
...
"Cyberpunk is a Speculative Fiction genre centered around the transformative effects of advanced science, information technology, computers and networks coupled with a breakdown or radical change in the social order. A genre that is dark and cynical in tone, it borrows elements from Film Noir, hard-boiled Detective Fiction and postmodern deconstruction to describe the Dystopian side of an electronic society."

"The plot will more than likely take place 20 Minutes into the Future in some City Noir, Industrial Ghetto or Crapsack World that tends to be marked by crime, cultural nihilism and bad weather, where cutting-edge technology is abused by everyone for the sake of selfish profit and pleasure."

"Heroes are often computer hackers or rebels, antiheroes almost to a man. These characters — 'criminals, outcasts, visionaries, dissenters and misfits' — call to mind the private eye of detective fiction."

"On the other hand, major villains are almost inevitably Police States or multinational conglomerates led by powerful businessmen with a number of gun-toting Mooks and corrupt politicians."
...
I recognise that it is a position against the relentless, naive and sometimes stifflingly indulgent techno-optimism of science-fiction leading up to that point.
...
However, in the process of working on witness.scifieconomicslab.net (and conversations with Alberto Cottica, who shaped much of my thought around social contracts I hadn't considered plausible before), I came to realize that much of what we actually find exciting - in stories, in history - are examples that profoundly violate the tenets of game theory.
...
This, of course, is simply because I care about such things. I loosely define this as the things anyone from the SAARC (or even ASEAN) region will instantly relate to, even in conversation with complete strangers:
...
- In-groups and loyalty to in-group norms is a very big thing. Being an individual is difficult on a social level; deprogramming is difficult.
...
**4. By the same rule, unhappiness is not equally distributed.**

No simple evil kingdoms, please. And while we're at it, let's iron out corporations-as-ultimate-holders-of-power. Business doesn't exist without people and relationships and a degree of public infrastructure (whether social, physical or both) to make such promises easier to deliver on. Amazon needs roads, needs contract law to be enforced, needs regulations and an operating environment that prevent startups from legally blowing up warehouses and kidnapping executives. The Medicis relied on their reputations and family connections as much as their wealth to have the kind of power they exercised. Even one of the most unstable trade environments I can think of - the old Silk Road - required high degree of trust and merchant's reputations for fair deals to operate, and required kingdoms spending resources on maintaining their ends of the infrastructure.
...
**5. Cherishes hybridity and hybrid cultures;**

Showcases both hackers of culture as well as people who find a wholesome embrace within it. In this it inherits from an incomplete thought I scribbled a while back, after seeing someone insult another for their 'mongrel' use of a particular language:
...
{% include image.html image="/assets/images/experiments/rice.jpeg" caption="Empty Road in Between Rice Field by Thanh Nguyễn" %}
